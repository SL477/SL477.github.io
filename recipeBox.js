                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement('input', { type: 'text', className: 'form-control', value: this.state.editName, onChange: function onChange(e) {
                                        _this2.setState({ editName: e.target.value });
                                    } }),
                                React.createElement(
                                    'label',
                                    { htmlFor: 'editor' },
                                    ...
                                    React.createElement(
                                        'a',
                                        { target: '_blank', href: 'https://link477.com/fccResponsiveWebDesign/markdownPreviewer.html' },
                                        'here'
                                    ),
                                    '):'
                                ),
                                React.createElement('textarea', { id: 'editor', rows: '10', cols: '150', className: 'form-control', onChange: function onChange(e) {
                                        _this2.setState({ editRecipe: e.target.value });
