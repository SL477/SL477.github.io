...
function startGame() {
  ...
  // myGameArea.canvas.setAttribute('width', '500px');
  // myGameArea.canvas.setAttribute('height', '500px');
...
function updateGameArea() {
  ...
  if (
    ...
    ballY <= playerY - paddleHeight / 2 + paddleHeight
  ) {
    vballX = -vballX;
    //vballY = -vballY;
  } else if (ballX <= 0) {
  ...
  //else if (ballX >= myGameArea.canvas.width - 20 && ballX <= myGameArea.canvas.width && ballY <= ballY - (paddleHeight / 2) && ballY >= ballY - (paddleHeight / 2) + paddleHeight) {
    ...
    ballX + 20 >= myGameArea.canvas.width - 20 &&
    ballX + 20 <= myGameArea.canvas.width
  ) {
    //alert("hit");
    vballX = -vballX;
    //vballY = -vballY;
