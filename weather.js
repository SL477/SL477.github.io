...
var Weather = function (_React$Component) {
    ...
    _createClass(Weather, [{
        ...
        value: function showPosition(position) {
            ...
            fetch("https://weather-proxy.freecodecamp.rocks/api/current?lat=" + position.coords.latitude.toString() + "&lon=" + position.coords.longitude.toString()).then(function (response) {
